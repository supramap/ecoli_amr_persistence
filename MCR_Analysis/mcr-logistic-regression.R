...
#genotypes <- genotypes[creation_date_time >= as.POSIXct("2016-04-04 20:14:38", format = "%Y-%m-%d %H:%M:%S")]
...
#Run validation
validation <- predict(model.cv, newx = x , s = "lambda.1se")